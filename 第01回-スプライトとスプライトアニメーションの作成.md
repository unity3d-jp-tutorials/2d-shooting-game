...
詳しくはドキュメントの[Sprite](https://docs.unity3d.com/ja/current/ScriptReference/Sprite.html)、[SpriteRenderer](https://docs.unity3d.com/jp/current/Manual/class-SpriteRenderer.html)を御覧ください。
...
詳しくはドキュメントの[SpriteEditor](https://docs.unity3d.com/ja/current/Manual/SpriteEditor.html)を御覧ください。
...
詳しくはドキュメントの[Prefabs](https://docs.unity3d.com/ja/current/Manual/Prefabs.html)を御覧ください。
