...
マウスをコライダーの緑色の線に近づけると緑色の■が表示されるので、これをクリックするとその部分を頂点として動かすことが可能です。新しい頂点を作り耐場合は、ハイライトされている緑の辺にカーソルを近づけると新しい■が表示されるので、これをドラッグすればOKです。■を削除したい場合は、Ctrl(Cmd)を押しながらカーソルを■に近づけると赤く表示されるので、その状態でクリックすれば削除出来ます。
