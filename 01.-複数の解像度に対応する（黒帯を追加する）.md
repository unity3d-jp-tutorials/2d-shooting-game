...
![](images/mobile/01/switch_android.png)
...
![](images/mobile/01/change_screen_size.png)
...
![カメラの見える範囲が広くなった状態](images/mobile/01/screen_1.png)
...
![](images/mobile/01/imported_black_texture.png)
...
![](images/mobile/01/edit_pixel_to_units.png)
...
![完成図](images/mobile/01/completed_black_screen.png)
<br/>図1.2: 完成図
...
![](images/mobile/01/drag_black_screen.png)
...
）](images/mobile/01/edit_transform_1.png)
...
![](images/mobile/01/duplicate.png)
...
![Positionが（ -5, 0, 0 ）Scaleが（ 2, 6, 1
）](images/mobile/01/edit_transform_2.png)
...
![](images/mobile/01/finish_blackscreen.png)
...
![わかりづらいがプレイヤーの半分が黒帯の上に表示されている](images/mobile/01/bad_sorting_layer.png)
...
![](images/mobile/01/selected_add_sorting_layer.png)
...
![](images/mobile/01/added_blackscreen_layer.png)
...
![](images/mobile/01/changed_sorting_layer.png)
...
![](images/mobile/01/finished_sorting_layer.png)
